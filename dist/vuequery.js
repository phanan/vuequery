(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["VueQuery"] = factory();
  else root["VueQuery"] = factory();
})(this, function() {
  return /******/ (function(modules) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var $ = function $(vm) {
          ...
          if (!(0, _helpers.isRoot)(vm) && !vm.$options.name) {
            (0, _utils2.default)(
              "Non-root component should have a `name` option",
              vm
            );
            return null;
          }
     ...
     */
            nextUntil: function nextUntil() {
              ...
              return $(
                (0, _helpers.siblingsUntilWithSort)(vm, until, filter, true)
              );
            },
     ...
     */
            parent: function parent() {
              ...
              return (0, _helpers.matches)(vm.$parent, selector)
                ? $(vm.$parent)
                : null;
            },
     ...
     */
            prevUntil: function prevUntil() {
              ...
              return $(
                (0, _helpers.siblingsUntilWithSort)(vm, until, filter, false)
              );
            },
 ...
 * @return {?VueComponent}
 */
        var siblingsWithSort = (exports.siblingsWithSort = function siblingsWithSort(
          vm,
          selector,
          ascending
        ) {
 ...
 * @return {Array.<VueComponent>}
 */
        var siblingsAllWithSort = (exports.siblingsAllWithSort = function siblingsAllWithSort(
          vm,
          selector,
          ascending
        ) {
 ...
 * @return {Array.<VueComponent>}
 */
        var siblingsUntilWithSort = (exports.siblingsUntilWithSort = function siblingsUntilWithSort(
          vm,
          until,
          filter,
          ascending
